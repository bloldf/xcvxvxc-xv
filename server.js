...
client.on('message',async message => { // تعريف ال message
    ...
    let devs = ["533944821228896257","593585813648965633"]; // هنا تحط ايدي الديف الي مسموح لهم بـ زياده الكريدتس
...
client.login('NjIyNzc3MjkwMjExNzIxMjM2.XcLiIA.jeQY4ADv_Cury_AYvI2V-pBVca4')